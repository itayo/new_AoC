...
std::vector<DayInfo> createDays() {
    ...
    days.push_back({std::make_unique<Day17>(), "17"});
    days.push_back({std::make_unique<Day18>(), "18"});
    ...
    days.push_back({std::make_unique<Day23>(), "23"});
    days.push_back({std::make_unique<Day24>(), "24"});
    //dayCreator
    return days;
}
